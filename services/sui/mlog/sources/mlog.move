...
/// Entry fun để Admin phê duyệt yêu cầu và thưởng coin.
    ...
    /// @param source_coin: Coin<MLOG_COIN> mà Admin đưa vào để chia và thưởng (CHUYỂN THEO GIÁ TRỊ)
    /// @param reward_amount: Số lượng MLOG_COIN muốn thưởng
public entry fun approve_and_reward(
    ...
    source_coin: &mut Coin<MLOG_COIN>,     // Pool coin của Admin để chia
    reward_amount: u64,
    ctx: &mut TxContext,
) {
